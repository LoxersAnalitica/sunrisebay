...
const scrollToContact = () => {
  // On mobile, the form is in #mobile-contact-form; on desktop it's in .hero
  ...
  return (
    <>
      <section className="hero">
        <img src="/assets/hero-bay.jpg" alt="Sunrise Bay Residences Cala Romántica Mallorca" className="hero-bg" />
      ...
      <section id="mobile-contact-form" style={{ backgroundColor: '#F9F8F6', padding: '5rem 1.5rem', borderTop: '1px solid var(--border-color)' }}>
        <div className="container">
          <p style={{
            ...
            Located in Cala Romántica, just five minutes from Estany d'en Mas cove, Sunrise Bay Residences is an exclusive collection of villas. A true oasis of peace in an exclusive area of Mallorca. A place to enjoy the Mediterranean essence and establish your new home, designed for year-round living.
          </p>
  ...
  return (
    <section className="benefits">
      <div className="container" style={{ textAlign: 'center' }}>
        <p className="value-add-subtitle">Outdoor Living</p>
        <h2 className="value-add-title" style={{ marginBottom: '3rem', textAlign: 'center' }}>Where Landscape and Home Merge</h2>

        <div className="benefits-grid" style={{ marginBottom: '3rem' }}>
          <div className="benefit-card">
            <div className="benefit-icon"><LeafIcon /></div>
            <h3 className="benefit-title">Privileged Natural Setting</h3>
            <p className="benefit-desc">159 semi-detached and detached villas with a social club, distributed across a 62,000 m² complex in an invaluable natural setting.</p>
          </div>

          <div className="benefit-card">
            <div className="benefit-icon"><ShieldIcon /></div>
            <h3 className="benefit-title">Indoor-Outdoor Connection</h3>
            <p className="benefit-desc">Villas designed to prioritize the connection between indoor and outdoor spaces, allowing the Mediterranean atmosphere and landscape to integrate into the homes.</p>
          </div>

          <div className="benefit-card">
            <div className="benefit-icon"><KeyIcon /></div>
            <h3 className="benefit-title">Year-Round Mediterranean Living</h3>
            <p className="benefit-desc">A true oasis of peace designed for year-round living. Enjoy the Mediterranean essence with private gardens, terraces, and optional pools.</p>
          </div>
        </div>
  ...
  return (
    <section className="value-add">
      <div className="container value-add-content">
        <div>
          <p className="value-add-subtitle">Location & Lifestyle</p>
          <h2 className="value-add-title">An exclusive enclave in eastern Mallorca</h2>
          <p className="value-add-text">
            Located in Cala Romántica, Manacor, just 5 minutes from the beach and 10 minutes from the charming Porto Cristo. A privileged setting where nature and the Mediterranean merge.
          </p>
          <ul className="value-add-list">
            <li className="value-add-item">
              <div className="value-add-item-icon"><CheckCircleIcon /></div>
              <div>
                <h4 className="value-add-item-title">Steps from the beach</h4>
                <p className="value-add-item-text">Estany d'en Mas cove just 5 minutes by car. Enjoy crystal-clear waters and golden sands year-round.</p>
              </div>
            </li>
            <li className="value-add-item">
              <div className="value-add-item-icon"><CheckCircleIcon /></div>
              <div>
                <h4 className="value-add-item-title">Private villa living</h4>
                <p className="value-add-item-text">Semi-detached and detached villas with private gardens, terraces, and the option for private pools.</p>
              </div>
            </li>
            <li className="value-add-item">
              <div className="value-add-item-icon"><CheckCircleIcon /></div>
              <div>
                <h4 className="value-add-item-title">Social club & community</h4>
                <p className="value-add-item-text">A social club and shared amenities within the complex for a connected, vibrant community life.</p>
              </div>
            </li>
          </ul>
        </div>
    ...
    <section className="location-map" style={{ padding: '4rem 0', backgroundColor: '#fff', borderTop: '1px solid var(--border-color)', borderBottom: '1px solid var(--border-color)' }}>
      <div className="container">
        ...
        <p style={{ fontFamily: 'var(--font-sans)', color: 'var(--text-muted)', textAlign: 'center', marginBottom: '3rem', maxWidth: '700px', margin: '0 auto 3rem auto', fontSize: '1rem', lineHeight: '1.6' }}>
          Cala Romántica, Manacor — an exclusive enclave on the eastern coast of Mallorca.
        </p>
        <div style={{ width: '100%', height: '450px', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 15px 35px rgba(0,0,0,0.1)' }}>
          <iframe
            src="https://maps.google.com/maps?q=39.521023,3.300489&t=&z=16&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="100%"
            style={{ border:0 }}
            allowFullScreen=""
    ...
    <section className="gallery">
      <div className="container">
        <div className="gallery-header" style={{ marginBottom: '2rem' }}>
          ...
          <h2 className="gallery-title">Discover Villa Living in Mallorca</h2>
        </div>
        <div className="gallery-grid">
          <div className="gallery-item">
            <img src="/assets/gallery-1.jpg" alt="Sunrise Bay Residences - Bright Mediterranean living space" />
            <div className="gallery-item-caption">Bright Mediterranean Interiors</div>
          </div>
          <div className="gallery-item">
            <img src="/assets/gallery-2.jpg" alt="Sunrise Bay Residences - Open-plan living and dining area" />
            <div className="gallery-item-caption">Open-Plan Living & Dining</div>
          </div>
          <div className="gallery-item">
            <img src="/assets/gallery-3.jpg" alt="Sunrise Bay Residences - Private terrace with pergola" />
            <div className="gallery-item-caption">Private Terraces with Pergola</div>
          </div>
          <div className="gallery-item">
            <img src="/assets/gallery-4.jpg" alt="Sunrise Bay Residences - Villa with private pool" />
            <div className="gallery-item-caption">Villas with Private Pool</div>
          </div>
        </div>
        <div style={{ textAlign: 'center', marginTop: '3rem' }}>
          <button onClick={scrollToContact} className="amoforms-action-btn" style={{
    ...
    <footer className="footer" style={{ paddingBottom: '3rem' }}>
      <div className="container">
        <p className="footer-text" style={{ marginBottom: '1rem' }}>
          Sunrise Bay Residences - Cala Romántica, Mallorca.
...
function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/34659414567?text=Hello,%20I%20would%20like%20to%20request%20information%20about%20Sunrise%20Bay%20Residences."
      target="_blank"
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ fontFamily: 'var(--font-sans)', lineHeight: '1.8', fontSize: '0.95rem' }}>
          <p style={{ marginBottom: '1.5rem' }}>
            At <strong>Sunrise Bay Residences</strong>, discretion and the protection of our clients' data are fundamental. This Privacy Policy describes how we collect, use, and protect the personal information we obtain through our platform.
          </p>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/kommo', {
        ...
        body: JSON.stringify({
          name: 'Dossier Request (Sunrise Bay)',
          phone: phone,
          email: email
        })
      })
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', color: 'var(--text-muted)', marginBottom: '25px', textAlign: 'center' }}>
           Please enter your details to receive the complete Sunrise Bay dossier.
        </p>
...
export default function App() {
  ...
  useEffect(() => {
    if (getCookieConsentValue("sunrise-bay-cookie-consent") === "true") {
      grantGoogleConsent();
    }
  ...
  return (
    <>
      <CookieConsent
        ...
        cookieName="sunrise-bay-cookie-consent"
