...
export default async function handler(req, res) {
    ...
    try {
        ...
        const kommoPayload = [
            {
                "name": "Lead Sunrise Bay - " + data.name,
                "status_id": 103175435,
                "pipeline_id": 13376411,
                "_embedded": {
                    "tags": [
                        { "name": "Sunrise Bay" }
                    ],
            ...
            "data": [
                {
                    ...
                    "user_data": {
                        ...
                        "ph": [hashData(data.phone.replace(/[^0-9]/g, ''))]
                    }
                }
            ]
        };

        const metaPromise = fetch('https://graph.facebook.com/v19.0/1241457837817081/events', {
            method: 'POST',
            headers: {
